...
sed -i 's#<a class="luci-link" href="https://github.com/openwrt/luci" target="_blank">Powered by <%= ver.luciname %> (<%= ver.luciversion %>)</a> target="_blank">OpenWRT定制版</a> /#' package/new/luci-theme-argon/luasrc/view/themes/argon/footer_login.htm
sed -i 's|<a href="https://github.com/jerrykuku/luci-theme-argon" target="_blank">ArgonTheme <%# vPKG_VERSION %></a>| target="_blank">ArgonTheme <%# vPKG_VERSION %></a> |g' package/new/luci-theme-argon/luasrc/view/themes/argon/footer_login.htm
