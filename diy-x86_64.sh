...
sed -i 's#<a class="luci-link" href="https://github.com/openwrt/luci" target="_blank">Powered by <%= ver.luciname %> (<%= ver.luciversion %>)</a> /#<a class="luci-link" href="https://github.com/zouchanggan/OpenWRT-24.10-Action" target="_blank">OpenWRT定制版</a> /#' package/new/luci-theme-argon/luasrc/view/themes/argon/footer_login.htm
